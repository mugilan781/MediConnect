...
async function run() {
  const sqlFile = path.join(__dirname, '../database/migration_notifications.sql');
  ...
  console.log(`Executing ${statements.length} statements from migration_notifications.sql...`);
  ...
  console.log('✅ Notifications & Reminders schema migration completed successfully!');
  process.exit(0);
}
