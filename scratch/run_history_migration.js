...
async function run() {
  const sqlFile = path.join(__dirname, '../database/migration_patient_history.sql');
  ...
  console.log(`Executing ${statements.length} statements from migration_patient_history.sql...`);
  ...
  console.log('✅ Patient History schema migration completed successfully!');
  process.exit(0);
}
